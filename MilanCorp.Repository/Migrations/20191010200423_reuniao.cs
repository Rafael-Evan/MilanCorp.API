...
{
    public partial class reuniao : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aniversariantes", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAD = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sala = table.Column<string>(type: "nvarchar(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    nomeDaNota = table.Column<string>(nullable: true),
                    termoDeAceite = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Materiais", x => new { x.Id, x.UploadId, x.UserId });
                    table.UniqueConstraint("AK_Materiais_Id", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Materiais_Uploads_UploadId",
                        column: x => x.UploadId,
